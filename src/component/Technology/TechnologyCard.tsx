...
const TechnologyCard = ({stack}:StackProps) => {
    return (
        <div  className=" md:w-82 w-150 md:h-auto border border-gray-300  rounded-2xl p-5 space-y-3">
            ...
            <button className="bg-black text-white py-3 md:px-20 px-55 rounded-md mx-auto flex mt-6 md:text-[15px] text-[18px]">Add to Stack</button>
        </div>
    );
};
